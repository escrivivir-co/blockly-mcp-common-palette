...
Como workaround, tras la [transpilación](https://nodejs.org/en/learn/typescript/transpile), typescript se genera como javascript y, por tanto, puede reducirse con el [generador de Javascript](https://github.com/google/blockly/tree/develop/generators/javascript) existente.