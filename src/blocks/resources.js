...
Blockly.Blocks["mcp_resource_callback"] = {
    init: function () {
        this.appendDummyInput().appendField("Recursos - Función Callback");
        this.appendStatementInput("CALLBACK_BODY").setCheck(null);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(290);
        this.setTooltip(
            "Función callback para procesar una solicitud de recurso"
        );
        this.setHelpUrl("https://modelcontextprotocol.io");
    },
};
